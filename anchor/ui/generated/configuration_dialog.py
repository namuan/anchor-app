...
class Ui_Configuration(object):
    def setupUi(self, Configuration):
        ...
        self.label = QtWidgets.QLabel(parent=self.jira)
        self.label.setGeometry(QtCore.QRect(10, 20, 71, 16))
        self.label.setObjectName("label")
        self.txt_jira_server = QtWidgets.QLineEdit(parent=self.jira)
        self.txt_jira_server.setGeometry(QtCore.QRect(90, 20, 351, 21))
        self.txt_jira_server.setObjectName("txt_jira_server")
        self.label_2 = QtWidgets.QLabel(parent=self.jira)
        self.label_2.setGeometry(QtCore.QRect(10, 60, 71, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(parent=self.jira)
        self.label_3.setGeometry(QtCore.QRect(10, 100, 71, 16))
        self.label_3.setObjectName("label_3")
        self.txt_jira_user = QtWidgets.QLineEdit(parent=self.jira)
        self.txt_jira_user.setGeometry(QtCore.QRect(90, 60, 351, 21))
        self.txt_jira_user.setObjectName("txt_jira_user")
        self.txt_jira_password = QtWidgets.QLineEdit(parent=self.jira)
        self.txt_jira_password.setGeometry(QtCore.QRect(90, 100, 351, 21))
        self.txt_jira_password.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.txt_jira_password.setObjectName("txt_jira_password")
        self.label_4 = QtWidgets.QLabel(parent=self.jira)
        self.label_4.setGeometry(QtCore.QRect(10, 140, 71, 16))
        self.label_4.setObjectName("label_4")
        self.txt_jira_jql = QtWidgets.QLineEdit(parent=self.jira)
        self.txt_jira_jql.setGeometry(QtCore.QRect(90, 140, 351, 21))
        self.txt_jira_jql.setObjectName("txt_jira_jql")
        self.btn_test_jira = QtWidgets.QPushButton(parent=self.jira)
        self.btn_test_jira.setGeometry(QtCore.QRect(330, 170, 113, 32))
        self.btn_test_jira.setObjectName("btn_test_jira")
        self.lbl_jira_server_status = QtWidgets.QLabel(parent=self.jira)
        self.lbl_jira_server_status.setGeometry(QtCore.QRect(90, 170, 231, 30))
        ...
        self.btn_save_configuration.setGeometry(QtCore.QRect(360, 250, 113, 32))
        ...
        self.btn_cancel_configuration.setGeometry(QtCore.QRect(250, 250, 113, 32))
    ...
    def retranslateUi(self, Configuration):
        ...
        self.label_4.setText(_translate("Configuration", "JQL"))
        self.txt_jira_jql.setPlaceholderText(_translate("Configuration", "project = FRN AND status IN (New, Ready, \"In Progress\") AND type IN (Story, Bug)"))
