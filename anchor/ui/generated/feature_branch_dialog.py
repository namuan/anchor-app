...
class Ui_FeatureBranchDialog(object):
    def setupUi(self, FeatureBranchDialog):
        ...
        FeatureBranchDialog.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
        FeatureBranchDialog.resize(475, 318)
        FeatureBranchDialog.setModal(True)
        self.btn_create_branch = QtWidgets.QPushButton(parent=FeatureBranchDialog)
        self.btn_create_branch.setGeometry(QtCore.QRect(350, 280, 113, 31))
        self.btn_create_branch.setObjectName("btn_create_branch")
        self.btn_cancel_create_branch = QtWidgets.QPushButton(parent=FeatureBranchDialog)
        ...
        self.txt_main_branch = QtWidgets.QLineEdit(parent=FeatureBranchDialog)
        ...
        self.label = QtWidgets.QLabel(parent=FeatureBranchDialog)
        ...
        self.label_2 = QtWidgets.QLabel(parent=FeatureBranchDialog)
        self.label_2.setGeometry(QtCore.QRect(60, 40, 391, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(parent=FeatureBranchDialog)
        self.label_3.setGeometry(QtCore.QRect(60, 60, 391, 16))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(parent=FeatureBranchDialog)
        self.label_4.setGeometry(QtCore.QRect(60, 80, 391, 16))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(parent=FeatureBranchDialog)
        self.label_5.setGeometry(QtCore.QRect(20, 148, 111, 20))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(parent=FeatureBranchDialog)
        self.label_6.setGeometry(QtCore.QRect(20, 188, 111, 20))
        self.label_6.setObjectName("label_6")
        self.txt_feature_branch = QtWidgets.QLineEdit(parent=FeatureBranchDialog)
        self.txt_feature_branch.setGeometry(QtCore.QRect(140, 188, 321, 21))
        self.txt_feature_branch.setObjectName("txt_feature_branch")
        self.lbl_error = QtWidgets.QLabel(parent=FeatureBranchDialog)
        self.lbl_error.setGeometry(QtCore.QRect(20, 258, 441, 16))
        self.lbl_error.setObjectName("lbl_error")
        self.chk_apply_stash = QtWidgets.QCheckBox(parent=FeatureBranchDialog)
        ...
        self.label_7 = QtWidgets.QLabel(parent=FeatureBranchDialog)
