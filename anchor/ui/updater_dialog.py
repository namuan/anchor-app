...
class Updater(QDialog):
    api_github_latest: QUrl = QUrl('https://api.github.com/repos/namuan/anchor-app-osx/releases/latest')

    def __init__(self, parent=None, flags=Qt.WindowType.Dialog | Qt.WindowType.WindowCloseButtonHint):
